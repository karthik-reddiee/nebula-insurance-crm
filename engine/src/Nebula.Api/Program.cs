...
builder.Services.AddScoped<CarrierMarketService>();
builder.Services.AddScoped<CommissionRevenueService>();
...
app.MapNeuronCompanionTelemetryEndpoints();
