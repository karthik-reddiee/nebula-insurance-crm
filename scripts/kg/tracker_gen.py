...
ROADMAP_TABLES: dict[str, dict[str, Any]] = {
    ...
    "roadmap:completed": {
        "header": "| Feature | Phase | Completion State |", "sep": "|---------|-------|------------------|",
        "select": lambda f: f.get("roadmap_section") == "Completed", "key": _roadmap_key, "reverse": False,
        "row": lambda f: _row([_link(f), f.get("phase", ""), f.get("completion_state", "")]),
    },
}
