...
F0035 modifies authentication/session behavior and session-continuity telemetry. This remediation revalidates security evidence against current code.
...
This security review documents current-code findings and should not be read as proof that the original 2026-05-24 closeout commit had the same dependency state.
