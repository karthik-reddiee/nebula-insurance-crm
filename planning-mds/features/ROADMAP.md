...
| [F0028 — Carrier & Market Relationship Management](./F0028-carrier-and-market-relationship-management/README.md) | CRM Release MVP+ | Promoted from Later to Now (2026-07-02, operator decision) to pull forward CRM-side carrier, market, appetite, appointment, and underwriter relationship context. F0019 submission workflow and F0023 search/reporting substrate are complete, so the major listed prerequisites are available. **Draft feature — needs story refinement and implementation contract before build.** |
...
- Reviewed 2026-07-02 (operator decision): promoted **F0028 — Carrier & Market Relationship Management** from `Later` to `Now` to pull CRM-side market relationship, appetite, appointment, and underwriter-contact context forward. Listed dependencies F0019 and F0023 are completed/archived, but F0028 remains Draft with zero stories; run planning/refinement before build to create story files, acceptance criteria, interaction contracts, and the implementation contract.
